...
var scriptURL = "https://cdn.jsdelivr.net/gh/qifbox/LA-Filter-PT-v9/";
...
$.getScript('https://cdn.jsdelivr.net/gh/qifbox/LA-Filter-PT-v9/js/lib/jstorage.js', function() {
  $.getScript('https://cdn.jsdelivr.net/gh/qifbox/LA-Filter-PT-v9/js/lib/taffy.js', function() {
    if ($.jStorage.get("language") == null) {
      setDefaultLanguage();
    }
    $.getScript(`https://cdn.jsdelivr.net/gh/qifbox/LA-Filter-PT-v9/lang/${$.jStorage.get("language")}.js`, function() {
      console.log("init");
      checkPage();
    });
  });
