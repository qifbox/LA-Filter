...
var scriptURL = "https://cdn.jsdelivr.net/gh/qifbox/LA-Filter-PT-v5/";
...
window.top.$.getScript('https://cdn.jsdelivr.net/gh/qifbox/LA-Filter-PT-v5/js/lib/jstorage.js', function() {
  window.top.$.getScript('https://cdn.jsdelivr.net/gh/qifbox/LA-Filter-PT-v5/js/lib/taffy.js', function() {
    if (window.top.$.jStorage.get("language") == null) {
      setDefaultLanguage();
    }
    window.top.$.getScript(`https://cdn.jsdelivr.net/gh/qifbox/LA-Filter-PT-v5/lang/${window.top.$.jStorage.get("language")}.js`, function() {
      console.log("init");
      checkPage();
    });
  });
  window.top.$.getScript('https://cdn.jsdelivr.net/gh/qifbox/LA-Filter-PT-v5/js/notify.js');
});
